  ...
  return (
    <section className="events-container">
      <div className="events-header">
        ...
        <h2 className="events-title">Related Events</h2>
      ...
      <div className="events-grid">
        <div className="events-menu">
          {Object.keys(eventData).map((key, index) => (
            <button
              key={key}
              className={`menu-item item-color-${(index % 5) + 1} ${activeTab === key ? "active" : ""}`}
        ...
        <div className="events-display">
          <div className={`content-panel panel-color-${(Object.keys(eventData).indexOf(activeTab) % 5) + 1}`} key={activeTab}>
            <div className="image-frame">
              <img src={eventData[activeTab].image} alt={eventData[activeTab].title} />
            </div>
